...
const Footer = () => {
    return (
        <footer className='footer-path bg-blue-300 min-h-[40vh] flex flex-col justify-center'>
            ...
            <div className="footer px-10 py-4 bg-blue-300 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Tune Craft Industries Ltd. <br />Providing reliable tech since 1992</p>
                </div>
